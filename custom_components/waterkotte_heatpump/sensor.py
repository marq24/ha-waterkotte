...
SENSOR_TYPES = {
    ...
    "temperature_mixing2": [
        "Temperature Mixing2",
        EcotouchTag.TEMPERATURE_MIXING2_CURRENT,
        DEVICE_CLASS_TEMPERATURE,
        TEMP_CELSIUS,
        "mdi:thermometer",
        False,
    ...
    "temperature_mixing3": [
        "Temperature Mixing3",
        EcotouchTag.TEMPERATURE_MIXING3_CURRENT,
        DEVICE_CLASS_TEMPERATURE,
        TEMP_CELSIUS,
        "mdi:thermometer",
        False,
    ...
    "anual_consumption_compressor": [
        "Anual Consumption Compressor",
    ...
    "anual_consumption_heating": [
        "Anual Consumption Heating",
    ...
    "anual_consumption_water": [
        "Anual Consumption Water",

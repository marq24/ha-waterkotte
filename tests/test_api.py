"""Tests for Waterkotte Heatpump api."""
import asyncio

import aiohttp
from custom_components.waterkotte_heatpump.api import (
    WaterkotteHeatpumpApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = WaterkotteHeatpumpApiClient("test", "test", async_get_clientsession(hass), lc_lang=hass.config.language.lower())
